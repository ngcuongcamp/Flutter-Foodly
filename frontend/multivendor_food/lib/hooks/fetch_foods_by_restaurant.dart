...
FetchHook useFetchFoodsByRestaurant(String idRestaurant) {
  ...
  Future<void> fetchData() async {
    ...
    try {
      // print('Fetching data for category: $idRestaurant');
      Uri url = Uri.parse('$appBaseUrl/api/food/byRestaurantId/$idRestaurant');
  ...
  useEffect(() {
    // print('useEffect triggered with idRestaurant: $idRestaurant');
